package in.rkumar.portfolioservice.config;
...
@Configuration
@OpenAPIDefinition(
	info = @Info(title = "Portfolio Service API", version = "1.0"),
    servers = {
        @Server(url = "http://localhost:8080", description = "API Gateway URL"),
        @Server(url = "http://localhost:8083", description = "Direct Service URL")
    },
